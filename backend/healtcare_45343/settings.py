"""
Django settings for healtcare_45343 project.
...
ROOT_URLCONF = 'healtcare_45343.urls'
...
WSGI_APPLICATION = 'healtcare_45343.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healtcare_45343 API",
    "DESCRIPTION": "API documentation for healtcare_45343 App",
    "VERSION": "v1",
}
